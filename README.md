...
API recebe um arquivo JSON com 100.000 usuários e oferece endpoints performáticos e bem estruturados para análise dos dados.
...
Executa uma autoavaliação dos principais endpoints da API e retornar um relatório de pontuação.
